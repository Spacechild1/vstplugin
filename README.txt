...
with vsthost~ you can load VST plugins within Pd on Windows, MacOS and Linux.
...
see vsthost~-help.pd for detailed instructions.

please report any issues or feature requests to https://git.iem.at/ressi/vsthost/issues

==============================================================================

build and install:

vsthost~ uses the pd-lib-builder build system (https://github.com/pure-data/pd-lib-builder)
...
2) 	cd into /vsthost and type 'make'. in case the Makefile doesn't automatically find your Pd installation,
